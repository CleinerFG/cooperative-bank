...
class Item {
  ...
  /**
   * Defines the icon path for the card using the PathManager utility.
   *
   * @public
   */
  defineIconPath() {
  ...
  /**
   * Defines the HTML path for the card using the PathManager utility.
   *
...
class Section {
  ...
  /**
   * Handles the configuration of paths (icon and HTML) for all items in the section.
   *
   * @public
   */
  pathHandler() {
