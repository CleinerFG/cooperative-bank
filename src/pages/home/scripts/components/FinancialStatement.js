...
export class FinancialStatement {
  ...
  /**
   * Switches the visibility state and updates the icon and `alt` attribute.
   *
   * @private
   */
  #switchVisibility() {
  ...
  /**
   * Renders the financial statement template into the container element.
   *
   * @private
   */
  #render() {
   ...
   *
   * @private
   * @param {"on" | "off"} visibility The visibility state to set.
   */
